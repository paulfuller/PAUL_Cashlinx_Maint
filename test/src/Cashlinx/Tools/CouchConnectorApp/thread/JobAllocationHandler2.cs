...
namespace CouchConsoleApp.thread
{
    class JobAllocationHandler2
    {
        ...
        private log4net.ILog log = log4net.LogManager.GetLogger(typeof(JobAllocationHandler2));
        ...
        public JobAllocationHandler2(ArchProcessForm mainForm, BackgroundWorker worker,
