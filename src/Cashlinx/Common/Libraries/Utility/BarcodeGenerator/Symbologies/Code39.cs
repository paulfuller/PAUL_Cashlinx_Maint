    ...
    class Code39 : BarcodeCommon, IBarcode
    {
        ...
        private string Encode_Code39()
        {
            ...
            foreach (char c in this.FormattedData)
            {
                ...
                {
                    if (_AllowExtended)
                        throw new System.Exception("EC39-1: Invalid data.");
                    else
                        throw new System.Exception("EC39-1: Invalid data. (Try using Extended Code39)");
                }//catch
            }//foreach
        ...
        private void InsertExtendedCharsIfNeeded(ref string pFormattedData)
        {
            string output = "";
