...
using Pawn.Forms.Inquiry.PartialPaymentInquiry;

namespace Pawn.Forms.Inquiry.GunBookInquiry
{
    public partial class GunBookSearchResults : SearchResults
    {
        ...
        public GunBookSearchResults(DataSet s, Inquiry criteria, string dataTableName)
        ...
        private void resultsGrid_dg_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                ...
                details = new GunBookDetails(iLoanTicketNumber, sortedData, e.RowIndex);
