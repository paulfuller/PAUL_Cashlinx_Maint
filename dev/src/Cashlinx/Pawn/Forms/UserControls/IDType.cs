...
* EDW 1/16/2012 - OK ID sort order support
*******************************************************************/
        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                if (!this.DesignMode)
                {
                    ...
                    {
                        // Create Array that is big enough max possible items + 1.
                        // +1 is for a "Select One" that will be added to beginning, later.
                        ArrayList idTypes =  new ArrayList(((int)CustomerIdTypes.FFL) + 1);
                        ...
                        // This Sort order is valid for TX and OK. e.g. Sort Order is same order as ID's
                        ...
                        for (index = 0; index < idTypes.Count; )
                        {
                            if (idTypes[index].ToString().Length == 0)
                            {
                                idTypes.RemoveAt(index);
                            }
                            else
