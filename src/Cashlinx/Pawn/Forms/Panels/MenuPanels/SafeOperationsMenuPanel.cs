...
{
    public partial class SafeOperationsMenuPanel : UserControl
    {
        ...
        public SafeOperationsMenuPanel()
        {
            InitializeComponent();
        }

        private void SafeOperationsMenuPanel_Load(object sender, EventArgs e)
        {
