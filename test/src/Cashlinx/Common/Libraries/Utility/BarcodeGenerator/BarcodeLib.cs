/*************************************************************************************
 * Namespace:       PawnUtilities.BarcodeGenerator
 * Class:           Barcode
 * 
 * Description      Library used to generate various Barcode formatted images
 * 
 * Example:         Barcode b = new Barcode();
 *                  int W = 300; int H = 150;
 *                  b.IncludeLabel = true;
 *                  b.ImageFormat = ImageFormatType.TIFF;
 *                  System.Drawing.Image image = b.Encode(EncodingType.CODE128C, "12345", W, H);
 *                  string sXML = b.XML;
 * 
 * History
...
namespace Common.Libraries.Utility.BarcodeGenerator
{
    ...
    public class Barcode: IDisposable
    {
        ...
        private EncodingType Encoded_Type = EncodingType.UNSPECIFIED;
        ...
        private string _XML = "";
        private ImageFormatType _ImageFormat = ImageFormatType.JPG;
        #endregion
        ...
        /// </summary>
        public EncodingType EncodedType
        {
        ...
        /// <param name="pWidth">Width of the resulting barcode.(pixels)</param>
        /// <param name="pHeight">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public Image Encode(EncodingType iType, string StringToEncode, int pWidth, int pHeight)
        {
            this.Width = pWidth;
            this.Height = pHeight;
        ...
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        /// <param name="pStringToEncode">Raw data to encode.</param>
        /// <param name="pForeColor">Foreground color</param>
        /// <param name="pBackColor">Background color</param>
        /// <param name="pWidth">Width of the resulting barcode.(pixels)</param>
        /// <param name="pHeight">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public Image Encode(EncodingType iType, string pStringToEncode, Color pForeColor, Color pBackColor, int pWidth, int pHeight)
        {
            this.Width = pWidth;
            this.Height = pHeight;
            return Encode(iType, pStringToEncode, pForeColor, pBackColor);
        ...
        /// <param name="pBackColor">Background color</param>
        /// <returns>Image representing the barcode.</returns>
        public Image Encode(EncodingType iType, string StringToEncode, Color pForeColor, Color pBackColor)
        {
        ...
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        internal Image Encode(EncodingType iType)
        {
            Encoded_Type = iType;
            return Encode();
        }//Encode()
        ...
        public void SaveImage(string Filename, ImageFormatType FileType)
        {
            try
            {
                if (_Encoded_Image != null)
                {
                    ((Bitmap)_Encoded_Image).Save(Filename, getImageFormat(FileType));
                }
            }//try
            catch (System.Exception ex)
            {
        ...
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data)
        {
        ...
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data, ref string XML)
        {
            using (Barcode b = new Barcode())
            {
        ...
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data, bool IncludeLabel)
        {
            using (Barcode b = new Barcode())
            {
        ...
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data, bool IncludeLabel, int Width, int Height)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
        ...
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
        ...
        /// <param name="Height">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor, int Width, int Height)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
        ...
        /// <param name="XML">XML representation of the data and the image of the barcode.</param>
        /// <returns>Image representing the barcode.</returns>
        public static Image DoEncode(EncodingType iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor, int Width, int Height, ref string XML)
        {
            using (Barcode b = new Barcode())
            {
                b.IncludeLabel = IncludeLabel;
