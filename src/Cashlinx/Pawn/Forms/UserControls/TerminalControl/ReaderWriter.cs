...
using CashlinxDesktop.UserControls.TerminalControl.PKI;

namespace CashlinxDesktop.UserControls.TerminalControl.SSHC {
	////////////////////////////////////////////////////////////
...
namespace CashlinxDesktop.UserControls.TerminalControl.SSHCV1 {

	internal class SSH1DataReader : CashlinxDesktop.UserControls.TerminalControl.SSHC.SSHDataReader {
	...
	internal class SSH1DataWriter : CashlinxDesktop.UserControls.TerminalControl.SSHC.SSHDataWriter {
...
namespace CashlinxDesktop.UserControls.TerminalControl.SSHCV2 {

	internal class SSH2DataReader : CashlinxDesktop.UserControls.TerminalControl.SSHC.SSHDataReader {
	...
	internal class SSH2DataWriter : CashlinxDesktop.UserControls.TerminalControl.SSHC.SSHDataWriter {
