...
{
    public partial class ProductHistoryDynamicPanel_Dialog : Form
    {
        ...
        public ProductHistoryDynamicPanel_Dialog(PawnLoan pawnLoan, int receiptIdx)
        {
            InitializeComponent();
        ...
        private void BuildTable()
        {
            ...
            //PAYDOWN OR LOAN UP
                ...
                || _pawnLoan.Receipts[_receiptIdx].Event == ReceiptEventTypes.LoanUp.ToString()
            )
            {
                tblContentLayout.Controls.Add(new LoanBasicInfoPanel(_pawnLoan, _receiptIdx), 0, 0);
                tblContentLayout.Controls.Add(new LoanRenewPanel(_pawnLoan, _receiptIdx), 1, 0);
                tblContentLayout.Controls.Add(new LoanChargesPanel(_pawnLoan, _receiptIdx), 2, 0);
                     ...
                     ReceiptEventTypes.PFI.ToString())
            {
                tblContentLayout.Controls.Add(new LoanGenericPanel(_pawnLoan, _receiptIdx, LoanGenericPanel.PanelType.PFICol1), 0, 0);
                tblContentLayout.Controls.Add(new LoanGenericPanel(_pawnLoan, _receiptIdx, LoanGenericPanel.PanelType.PFICol2), 1, 0);
                tblContentLayout.Controls.Add(new LoanGenericPanel(_pawnLoan, _receiptIdx, LoanGenericPanel.PanelType.PFICol3), 2, 0);
            }
