...
namespace Support.Forms.Pawn.Customer
{
    ...
    public partial class UpdateAddress : Form
    {
        ...
        private void UpdateAddress_Load(object sender, EventArgs e)
        {
            ...
            this.DisableMailingAddressControls();
            this.DisablePhysicalAddressControls();
            this.DisableWorkAddressControls();
            this.DisableAdditionalAddressControls();
        }
        /*__________________________________________________________________________________________*/
        private void LoadDataInControls()
        {
            ...
            if (_custAddrToView != null)
            {
                ...
                if (_allAddressesChange)
                {
                    ...
                    custstate = null;
                    // wcm 3/7/12 Requiement to disable focus to gets
...
#endregion
        #region SCREEN DATA MANIPULATION
        /*__________________________________________________________________________________________*/
        ...
        private void makeFieldsReadOnly()
        {
            ...
            this.custPhysicalAddr1.ReadOnly = true;
            ...
            this.custMailingAddr1.ReadOnly = true;
            ...
            this.custWorkAddr1.ReadOnly = true;
            ...
            this.custAddlAddr1.ReadOnly = true;
        ...
        // WCM 3/7/12 to disable focus modify these events
        /*__________________________________________________________________________________________*/
        ...
        */
        ...
        // wcm 3/29/12 Commented out logic for user prompt data is read only
        /*__________________________________________________________________________________________*/
