...
namespace Reports
{
    public class ExtensionMemoOhioIndiana : AbstractExtensionMemo
    {
        //Private variables
        ...
        public ExtensionMemoOhioIndiana(IPdfLauncher pdfLauncher)
            : base(pdfLauncher)
        {
               ...
               if (!string.IsNullOrEmpty(rptFileName))
                {
                    ...
                    topDataTable.AddCell(new PdfPCell(new Paragraph(extnInfo.PawnChargePaidTo.FormatDate(), rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_RIGHT });
                   ...
                   /* if (GlobalDataAccessor.Instance.CurrentSiteId.State.Equals(States.Ohio))
                    ...
                    {*/
                        ...
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph("Pawn Charge :", rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_LEFT });
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph((extnInfo.PawnChargeAtMaturity).ToString("c"), rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_LEFT });
                        bottomDataTable.AddCell(new PdfPCell(new Phrase()) { Border = Rectangle.NO_BORDER });
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph("Pawn Charge :", rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_RIGHT });
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph(((extnInfo.PawnChargeAtPfi).ToString("c")), rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_RIGHT });

                        bottomDataTable.AddCell(new PdfPCell(new Paragraph("**TOTAL** :", rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_LEFT });
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph((extnInfo.Amount + extnInfo.PawnChargeAtMaturity).ToString("c"), rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_LEFT });
                        bottomDataTable.AddCell(new PdfPCell(new Phrase()) { Border = Rectangle.NO_BORDER });
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph("**TOTAL** :", rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_RIGHT });
                        bottomDataTable.AddCell(new PdfPCell(new Paragraph((extnInfo.Amount + extnInfo.PawnChargeAtPfi).ToString("c"), rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_RIGHT });
                    ...
                    mainTable.AddCell(new PdfPCell(new Phrase()) { Border = Rectangle.NO_BORDER, Colspan = mainTableColumns });
                    mainTable.AddCell(new PdfPCell(new Paragraph("Pledgor :", rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_LEFT });
                    ...
                    mainTable.AddCell(new PdfPCell(new Paragraph("Pledgor", rptFont)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 3 });
