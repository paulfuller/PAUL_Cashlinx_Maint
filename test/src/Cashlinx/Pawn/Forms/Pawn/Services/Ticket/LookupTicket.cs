...
namespace Pawn.Forms.Pawn.Services.Ticket
{
    public partial class LookupTicket : Form
    {
        ...
        void bwLookupPawnTicket_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (_custObject.PartyId == string.Empty)
            {
        ...
        private void FindLayawayTicket()
        {
            ...
            try
            {
                ...
                BackgroundWorker bwLookupLayawayTicket = new BackgroundWorker();
                bwLookupLayawayTicket.DoWork += new DoWorkEventHandler(bwLookupLayawayTicket_DoWork);
                bwLookupLayawayTicket.RunWorkerCompleted += new RunWorkerCompletedEventHandler(bwLookupLayawayTicket_RunWorkerCompleted);
        ...
        {
            if (this.textBoxStoreNumber.Text == "")
            {
                _storeNumber = Convert.ToInt32(GlobalDataAccessor.Instance.CurrentSiteId.StoreNumber);
            }
            else
            {
