    ...
    class Postnet : BarcodeCommon, IBarcode
    {
        ...
        private string Encode_Postnet()
        {
            ...
            switch (Raw_Data.Length)
            {
                ...
                case 9:
                case 11: break;
                default: throw new System.Exception("EPOSTNET-2: Invalid data length. (5, 6, 9, or 11 digits only)");
            }//switch
            ...
            foreach (char c in Raw_Data)
            {
                ...
                {
                    throw new System.Exception("EPOSTNET-2: Invalid data. (Numeric only) --> " + ex.Message);
                }//catch
            }//foreach
