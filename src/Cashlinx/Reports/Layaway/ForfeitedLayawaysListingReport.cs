...
{
    public class ForfeitedLayawaysListingReport : ReportBase
    {
        ...
        public ForfeitedLayawaysListingReport(IPdfLauncher pdfLauncher)
            : base(pdfLauncher)
        {
        ...
        private void WriteColumns(PdfPTable columntable)
        {
            ...
            WriteCell(columntable, "Tr. Date", ReportFontUnderlined, 1, (int)Element.ALIGN_LEFT, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
            WriteCell(columntable, "Amount", ReportFontUnderlined, 1, (int)Element.ALIGN_CENTER, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
            WriteCell(columntable, "Tot pd. In", ReportFontUnderlined, 1, (int)Element.ALIGN_CENTER, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
            WriteCell(columntable, "Restocking", ReportFontUnderlined, 1, (int)Element.ALIGN_CENTER, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
            WriteCell(columntable, "Shop Cred.", ReportFontUnderlined, 1, (int)Element.ALIGN_CENTER, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
            WriteCell(columntable, "Coupons", ReportFontUnderlined, 1, (int)Element.ALIGN_LEFT, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
            WriteCell(columntable, "Payments", ReportFontUnderlined, 1, (int)Element.ALIGN_LEFT, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
        }

        private void WriteDetail(PdfPTable detailTable)
        {
            
            foreach (LayawayVO  listing in ReportObject.ForefeitedLayawaysListingsList)
            {
                int currentRow = 1;
                ...
                //var shopCreditTenders = (from r in listing.TenderDataDetails where r.TenderType == "SCIN" select r);
                //shopCredit = shopCreditTenders.Sum(amt => amt.TenderAmount);
                ...
                foreach (Receipt receipt in paymentReceipts)
                {
                    ...
                    else
                    {
                        ...
                        WriteCell(detailTable, receipt.Date.ToString("d"), ReportFontSmall, 1, (int)Element.ALIGN_CENTER, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
                        WriteCell(detailTable, string.Empty, ReportFontSmall, 1, (int)Element.ALIGN_CENTER, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
        ...
        private void WriteSummary(PdfPTable summaryTable)
        {
            ...
            WriteCell(summaryTable, ReportObject.ForefeitedLayawaysListingsList.Count.ToString() + " Layaway Forfeitures", ReportFont, 2, (int)Element.ALIGN_LEFT, (int)Element.ALIGN_TOP, (int)Rectangle.NO_BORDER);
        ...
        {
            WriteCell(linestable, StringUtilities.fillString("_", 138), ReportFont, 9, (int)Element.ALIGN_LEFT, (int)Rectangle.NO_BORDER);
        }

        private void ReportHeader(PdfPTable headingtable, Image gif, ForfeitedLayawaysListingReport pageEvent)
        {
            ...
            //draw line
            WriteCell(headingtable, StringUtilities.fillString("_", 142), ReportFont, 9, (int)Element.ALIGN_LEFT, (int)Rectangle.NO_BORDER);
        ...
        public bool CreateReport()
        {
            ...
            try
            {
                ...
                ForfeitedLayawaysListingReport events = this;
        ...
        public override void OnStartPage(PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            try
            {
                ...
                ReportHeader(headerTbl, logo, (ForfeitedLayawaysListingReport)writer.PageEvent);
                ...
                headerTbl.WriteSelectedRows(0, -1, 30, (document.PageSize.Height - 10), writer.DirectContent);
            }
            catch (Exception)
            {
                return;
