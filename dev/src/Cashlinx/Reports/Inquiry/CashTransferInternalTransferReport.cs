...
{
    public class CashTransferInternalTransferReport : PdfPageEventHelper
    {
        ...
        public CashTransferInternalTransferReport()
        {
        ...
        public bool CreateReport(DataTable dt)
        {
            ...
            _ReportTitle = "Internal Cash Transfer Details";
        ...
        private void PrintReportDetailValues(PdfPTable table)
        {
            ...
            paragraph = new Paragraph(_dataTable.Rows[0]["ACCEPTEDBY"].ToString(), _reportFont);
            cell = new PdfPCell(paragraph);
            cell.Border = Rectangle.NO_BORDER;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.VerticalAlignment = Element.ALIGN_TOP;
