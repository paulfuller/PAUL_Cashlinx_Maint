...
{
    class JobAllocationHandlerMain
    {
        ...
        private log4net.ILog log = log4net.LogManager.GetLogger(typeof(JobAllocationHandlerMain));
        ...
        private void Execute()
        {
            ...
            while (true)
            {
                ...
                {
                    //this.mainForm.setStatusLabel("Waiting for threads to end...");
