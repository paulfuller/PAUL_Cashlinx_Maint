...
{
    public class Group17_PettyCash : AbstractDSTRGroup
    {
        private int _Count;
        private decimal _Total;

        public Group17_PettyCash(DSTRReportContext dstrContext, string dataTableName)
        ...
        protected override void OnBuildSection()
        {
            try
            {
                ...
                AddGroupTitle(dataTable, "Petty Cash");
        ...
        protected override void PrintGroupDetailRecord(PdfPTable pdfTable, int index, DataRow dataRow, bool shadeRow)
        {
            ...
            pdfTable.AddCell(GetCell(GetStringValue(dataRow["DESCRIPTION"]), DataFont, Element.ALIGN_LEFT, shadeRow));
