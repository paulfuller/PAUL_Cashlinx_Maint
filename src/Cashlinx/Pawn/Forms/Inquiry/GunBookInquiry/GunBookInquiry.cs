...
{
    public class GunBookInquiry : Inquiry
    {
        ...
        public override string ToString()
        {
            ...
            retval += string.Format("\nSorted By: {0},  {1}\n",
                StringDBMap_Enum<sortField_enum>.displayValue(this.sortBy),
        ...
        {
            DataSet outputDataSet = getDataSet("ED_PAWN_INQUIRIES_13X", "get_gunbook_data_count",
        ...
        public DataSet getData()
        {
            DataSet outputDataSet = getDataSet("PAWN_Inquiries", "get_partial_payment_data",
                                new List<OracleProcParam>
                                {
                                    ...
                                    new OracleProcParam("p_sortBy", StringDBMap_Enum<GunBookInquiry.sortField_enum>.toDBValue(sortBy)),
