...
namespace Pawn.Forms.GunUtilities.EditGunBook
{
    public partial class EditGunBookRecord : CustomBaseForm
    {
        ...
        private CustomerVO gunBookCustomer;
        ...
        private void EditGunBookRecord_Load(object sender, EventArgs e)
        {
            ...
            if (gunBookData != null && gunBookData.Rows.Count > 0)
            {
                ...
                if (!SecurityProfileProcedures.CanUserModifyResource("EDIT GUN BOOK", GlobalDataAccessor.Instance.DesktopSession.LoggedInUserSecurityProfile, CashlinxDesktopSession.Instance) &&
                    !SecurityProfileProcedures.CanUserModifyResource("EDIT RESTRICTED GUN BOOK FIELDS", GlobalDataAccessor.Instance.DesktopSession.LoggedInUserSecurityProfile, CashlinxDesktopSession.Instance))
                {
        ...
        private void customButtonClose_Click(object sender, EventArgs e)
        {
            string errorCode;
            string errorText;
            RetailProcedures.LockItem(CashlinxDesktopSession.Instance, icn.Text, out errorCode, out errorText, "N");            
        ...
        private void AcquisitionEdit_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            CashlinxDesktopSession.Instance.GunAcquireCustomer = true;
            CashlinxDesktopSession.Instance.CustomerEditType = CustomerType.RECEIPT;
        ...
        private void DispositionReplace_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            CashlinxDesktopSession.Instance.CustomerEditType = CustomerType.NONE;
            NavControlBox.IsCustom = true;
        ...
        private void LoadItemData()
        {
            ...
            {
                CashlinxDesktopSession.Instance.ActivePawnLoan.Items = new List<Item>(1);
                CashlinxDesktopSession.Instance.ActivePawnLoan.Items.Add(Utilities.CloneObject(gunItemData));
