...
namespace Support.Forms.Pawn.Customer
{
    ...
    {
        private CustomerVOForSupportApp _customerToView;
        private CustomerVOForSupportApp _updatedCustomer;

        private string ParentFormName;
        private string ThisFormName = "ViewCustomerInformationReadOnly";
        ...
        //SR 2/16/2010 Roles and resources check added ... check the privileges of the logged in user to determine if the user can edit any information
        /*__________________________________________________________________________________________*/
        private void ViewCustomerInformation_Load(object sender, EventArgs e)
        {
            ownerFrm = this.Owner;
            this.NavControlBox.Owner = this;
            //ParentFormName = this.NavControlBox.CustomDetail;
            this.NavControlBox.CustomDetail = ThisFormName;
        ...
        /*__________________________________________________________________________________________*/
        public CustomerVOForSupportApp UpdatedCustomerToView
        {
            set
            {
        ...
        //private void linkLabelCommentsEdit_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        //{
       ...
       private void linkLabelCommentsEdit_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            this.NavControlBox.IsCustom = true;
            this.NavControlBox.CustomDetail = "UpdateCommentsandNotes";
            this.NavControlBox.Action = NavBox.NavAction.SUBMIT; 
...
/*
        ...
        private void linkLabelIDEdit_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        {
...
*/
       /*__________________________________________________________________________________________*/
        private void linkLabelIDEdit_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            this.NavControlBox.IsCustom = true;
            this.NavControlBox.CustomDetail = "UpdateCustomerIdentification";
            this.NavControlBox.Action = NavBox.NavAction.SUBMIT; 
        ...
        private void linkLabelContactInfo_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            this.NavControlBox.IsCustom = true;
            this.NavControlBox.CustomDetail = "UpdateCustomerContactDetails";
            this.NavControlBox.Action = NavBox.NavAction.SUBMIT; 
        ...
        private void LoadCustomerInfoToView()
        {
            try
            {
                ...
                _customerToView = Support.Logic.CashlinxPawnSupportSession.Instance.ActiveCustomer;
