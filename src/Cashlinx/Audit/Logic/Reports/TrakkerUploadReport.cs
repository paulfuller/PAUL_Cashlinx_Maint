...
namespace Audit.Reports
{
    public class TrakkerUploadReport : ReportBase
    {
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(scanSequenceNumber.ToString(), ReportFont));
            cell.Colspan = 1;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(trakFlag, ReportFont));
            cell.Colspan = 1;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = Rectangle.NO_BORDER;
            return cell;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(trakID.ToString(), ReportFont));
            cell.Colspan = 1;
            cell.Border = Rectangle.NO_BORDER;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            return cell;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(postAuditStatus, ReportFont));
            cell.Colspan = 1;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = Rectangle.NO_BORDER;
            return cell;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(retail.ToString("C"), ReportFont));
            cell.Colspan = 1;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Border = Rectangle.NO_BORDER;
            return cell;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(cost.ToString("C"), ReportFont));
            cell.Colspan = 1;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Border = Rectangle.NO_BORDER;
            return cell;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(status, ReportFont));
            cell.Colspan = 1;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = Rectangle.NO_BORDER;
            return cell;
        ...
        {
            PdfPCell cell = new PdfPCell(new Phrase(merchDescription, ReportFont));
            cell.Colspan = 3;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = Rectangle.NO_BORDER;
            return cell;
        ...
        private void SectionICNsSinceLastInventory(PdfPTable table, int columnsCount)
        {
            ...
            int icnCategoryCount = 0;

            //2
            decimal totalICNsNotSoldCost = 0.0m;
            decimal totalICNsNotSoldRetail = 0.0m;
            int totalICNsNotSold = 0;

            //3
            decimal totalICNsOnLayawayCost = 0.0m;
            decimal totalICNsOnLayawayRetail = 0.0m;
            int totalICNsOnLayaway = 0;

            //4
            decimal totalICNsSoldCost = 0.0m;
            decimal totalICNsSoldRetail = 0.0m;
            int totalICNsSold = 0;
      
            List<AuditReportsObject.TrakkerUploadReportSinceLastInventory> listFields = GetTrakkerUploadFields((int)EnumTrakkerUploadReportCategories.TempICNsSinceLastInventory);
            ...
            {
                foreach (AuditReportsObject.TrakkerUploadReportSinceLastInventory field in listFields)
                {
                    counter++;
                    WriteCell(table, counter.ToString() + ".", ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
                    ...
                    if(field.Status.Equals("SOLD"))
                    {
                        totalICNsSoldCost += field.Cost;
                        totalICNsSoldRetail += field.Retail;
                        totalICNsSold++;
                    }
                    if(field.Status.Equals("LAY"))
                    {
                        totalICNsOnLayawayCost += field.Cost;
                        totalICNsOnLayawayRetail += field.Retail;
                        totalICNsOnLayaway++;
                    }
                    if(!field.Status.Equals("SOLD") && !field.Status.Equals("LAY"))
                    {
                        totalICNsNotSoldCost += field.Cost;
                        totalICNsNotSoldRetail += field.Retail;
                        totalICNsNotSold++;
                    }
                }
            }
            ...
            WriteCell(table, "Total Merchandise Added:", ReportFontMediumBold, 5, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, counter.ToString(), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalCost.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalRetail.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            ...
            WriteCell(table, "1.", ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, "Total New Temporary ICN's", ReportFont, 4, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, counter.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalCost.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalRetail.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, string.Empty, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);

            WriteCell(table, "2.", ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, "Total New Temporary ICN's Not Sold or Layaway", ReportFont, 4, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsNotSold.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsNotSoldCost.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsNotSoldRetail.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, string.Empty, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);

            WriteCell(table, "3.", ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, "Total New Temporary ICN's On Layaway", ReportFont, 4, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsOnLayaway.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsOnLayawayCost.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsOnLayawayRetail.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, string.Empty, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);

            WriteCell(table, "4.", ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, "Total New Temporary ICNs Sold - Not Reconciled", ReportFont, 4, Element.ALIGN_LEFT, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsSold.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsSoldCost.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, totalICNsSoldRetail.ToString("C"), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
            WriteCell(table, string.Empty, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
        ...
        private void SectionMissingItems(PdfPTable table, int columnsCount)
        {
            ...
            List<AuditReportsObject.TrakkerUploadReportSinceLastInventory> listFields = GetTrakkerUploadFields((int)EnumTrakkerUploadReportCategories.MissingItems);
            int counter = 0;
            decimal totalCost = 0.0m;
            decimal totalRetail = 0.0m;
            if (listFields != null && listFields.Count > 0)
            {
                foreach (AuditReportsObject.TrakkerUploadReportMissingItems field in listFields)
                {
                    ...
                    WriteCell(table, counter.ToString() + ".", ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_BOTTOM, Rectangle.NO_BORDER);
                    WriteSectionDetails(table, field.ICN, field.MerchandiseDescription, field.Cost, field.Retail, field.Status);
                    WriteCell(table, StringUtilities.fillString("_", 9), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    totalCost += field.Cost;
                    totalRetail += field.Retail;
                }
            }
            ...
            WriteCell(table, "Total Merchandise Not Found:", ReportFontMediumBold, 5, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, counter.ToString(), ReportFontMediumBold, 1, Element.ALIGN_RIGHT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalCost.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalRetail.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
        ...
        private void SectionNXTsSinceLastInventory(PdfPTable table, int columnsCount)
        {
            ...
            List<AuditReportsObject.TrakkerUploadReportSinceLastInventory> listFields = GetTrakkerUploadFields((int)EnumTrakkerUploadReportCategories.NXTICNsSinceLastInventory);
            int counter = 0;
            decimal totalRetail = 0.0m;
            if (listFields != null && listFields.Count > 0)
            {
                foreach (AuditReportsObject.TrakkerUploadReportNXTsSinceLastInventory field in listFields)
                {
                    ...
                    WriteCell(table, field.TransactionNumber, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    totalRetail += field.Retail;
                }
            }
            WriteCell(table, string.Empty, ReportFont, columnsCount, Element.ALIGN_CENTER, Rectangle.NO_BORDER, false);
            ...
            //WriteCell(tableIcnsSinceLastInventory, PawnUtilities.String.StringUtilities.fillString("_", 144), ReportFont, 9, Element.ALIGN_LEFT, Rectangle.NO_BORDER, false);
            WriteCell(table, "Total New NXT ICN's:", ReportFontMediumBold, 4, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, counter.ToString(), ReportFontMediumBold, 1, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalRetail.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, string.Empty, ReportFontBold, 2, Element.ALIGN_LEFT, Rectangle.TOP_BORDER, false);
            WriteCell(table, string.Empty, ReportFont, columnsCount, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
        }
        ...
        private void SectionUnexpectedItems(PdfPTable table, int columnsCount)
        {
            ...
            List<AuditReportsObject.TrakkerUploadReportSinceLastInventory> listFields = GetTrakkerUploadFields((int)EnumTrakkerUploadReportCategories.UnexpectedItems);
            int counter = 0;
            decimal totalCost = 0.0m;
            if (listFields != null && listFields.Count > 0)
            {
                foreach (AuditReportsObject.TrakkerUploadReportUnexpectedItems field in listFields)
                {
                    ...
                    WriteCell(table, field.TrakID.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.ScanSequence.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.Status, ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.TrakFlag, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, StringUtilities.fillString("_", 9), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    totalCost += field.Cost;
                }
            }
            WriteCell(table, string.Empty, ReportFont, columnsCount, Element.ALIGN_CENTER, Rectangle.NO_BORDER, false);
            WriteCell(table, string.Empty, ReportFont, columnsCount, Element.ALIGN_CENTER, Rectangle.NO_BORDER, false);
            WriteCell(table, "Total Merchandise Found:", ReportFontMediumBold, 4, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, counter.ToString(), ReportFontMediumBold, 1, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalCost.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
        ...
        private void SectionDuplicateScans(PdfPTable table, int columnsCount)
        {
            ...
            List<AuditReportsObject.TrakkerUploadReportSinceLastInventory> listFields = GetTrakkerUploadFields((int)EnumTrakkerUploadReportCategories.DuplicateScans);
            int counter = 0;
            decimal totalCost = 0.0m;
            if (listFields != null && listFields.Count > 0)
            {
                foreach (AuditReportsObject.TrakkerUploadReportDuplicateScans field in listFields)
                {
                    ...
                    WriteSectionDetails(table, field.ICN, field.MerchandiseDescription, field.Cost);
                    WriteCell(table, field.TrakID.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.AuditLocation, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.ScanSequence.ToString(), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.Status, ReportFont, 1, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, field.TrakFlag, ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
                    WriteCell(table, StringUtilities.fillString("_", 9), ReportFont, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.NO_BORDER);
            ...
            WriteCell(table, string.Empty, ReportFont, columnsCount, Element.ALIGN_CENTER, Rectangle.NO_BORDER, false);
            //WriteCell(tableIcnsSinceLastInventory, PawnUtilities.String.StringUtilities.fillString("_", 144), ReportFont, 9, Element.ALIGN_LEFT, Rectangle.NO_BORDER, false);
            WriteCell(table, "Total Duplicate Scans:", ReportFontMediumBold, 4, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, counter.ToString(), ReportFontMediumBold, 1, Element.ALIGN_LEFT, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
            WriteCell(table, totalCost.ToString("C"), ReportFontMediumBold, 1, Element.ALIGN_CENTER, Element.ALIGN_TOP, Rectangle.TOP_BORDER);
        ...
        private List<AuditReportsObject.TrakkerUploadReportSinceLastInventory> GetTrakkerUploadFields(int category)
        {
            var trakkerUploadFieldsList = from trakkerUploadFields in ReportObject.ListTrakkerUploadReportField where trakkerUploadFields.Category == category select trakkerUploadFields;
            return trakkerUploadFieldsList.ToList();
        }
        #endregion

        #region Constructors
        public TrakkerUploadReport()
        ...
        public override void OnEndPage(PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            //add GunTotals
            string gunText = "Trakker Upload Report";
            float len2 = footerBaseFontGunTotals.GetWidthPoint(gunText, 7);
            contentByte.BeginText();
            contentByte.SetFontAndSize(footerBaseFontGunTotals, 7);
