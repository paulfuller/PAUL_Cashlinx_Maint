...
{
    public class Group20_CancelCSO : AbstractDSTRGroup
    {
        private int _Count;
        private decimal _Total;
        private decimal _TotalFee;

        public Group20_CancelCSO(DSTRReportContext dstrContext, string dataTableName)
        ...
        protected override void OnBuildSection()
        {
            try
            {
                ...
                AddGroupTitle(dataTable, "CSO Cancellations");
        ...
        protected override void PrintGroupDetailRecord(PdfPTable pdfTable, int index, DataRow dataRow, bool shadeRow)
        {
            ...
            decimal csoFee = -GetDecimalValue(dataRow["CSOFEE"]);
