...
#line 1 "TypeAheadTextBox.feature"
#line hidden
        ...
        public virtual void TypedThreeLetters(string first_Two_Chars, string third_Char, string typeahead_Option, string[] exampleTags)
        {
...
#line 9
 testRunner.Then(string.Format("the typeahead options should include {0}", typeahead_Option));
#line hidden
...
#line 17
 testRunner.Then("the typeahead options should be empty");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 24
 testRunner.Then(string.Format("there should be {0} typeahead options", n));
#line hidden
            this.ScenarioCleanup();
        }
...
#line 34
 testRunner.Then("the typeahead options should be the same");
#line hidden
            this.ScenarioCleanup();
        }
    }
