...
namespace Reports
{
    public class ReleaseToClaimantReport : PdfPageEventHelper
    {
        #region Variables
        ...
        {
            PdfPCell cell = null;
            cell = new PdfPCell(new Paragraph("Release To Claimant", _reportFont));
        ...
        {
            WriteBorderColumn(headerTableNoBorder, 2, "Owner First, Last:", Element.ALIGN_LEFT, _reportFont);
            WriteBorderColumn(headerTableNoBorder, 1, "DOB:", Element.ALIGN_LEFT, _reportFont);
            WriteBorderColumn(headerTableNoBorder, 6, "Address:", Element.ALIGN_LEFT, _reportFont);
            ...
            WriteBorderColumn(headerTableNoBorder, 6, CurrentCust.CustHomeAddress, Element.ALIGN_LEFT, _reportFont);
            WriteBorderColumn(headerTableNoBorder, 1, HoldData.TicketNumber.ToString(), Element.ALIGN_LEFT, _reportFont);
            WriteBorderColumn(headerTableNoBorder, 1, HoldData.UserId, Element.ALIGN_LEFT, _reportFont);
        }
        ...
        {
             string wasRestitutionPaid = string.Empty;
            if (HoldData.RestitutionPaid == true )
                wasRestitutionPaid = "YES";
            else
                wasRestitutionPaid = "NO";

           WriteBorderColumn(footerTableWithBorders, 3, "REASON FOR RELEASE:", Element.ALIGN_LEFT, _reportFont);
            ...
            WriteBorderColumn(footerTableWithBorders, 1, "RESTITUTION COLLECTED:", Element.ALIGN_LEFT, _reportFont);
            WriteBorderColumn(footerTableWithBorders, 2, "RESTITUTION AMT:", Element.ALIGN_LEFT, _reportFont);


            WriteBorderColumn(footerTableWithBorders, 3, HoldData.HoldComment, Element.ALIGN_LEFT, _reportFont);
            ...
            WriteBorderColumn(footerTableWithBorders, 1, wasRestitutionPaid , Element.ALIGN_LEFT, _reportFont);
            WriteBorderColumn(footerTableWithBorders, 2, HoldData.RestitutionAmount.ToString("C"), Element.ALIGN_LEFT, _reportFont);

        }

        private void ReportFooterNoBorders(PdfPTable footerTable)
        {
            // changed from 5 to 10 to add a little more room.
            WriteBlankRow(footerTable, 10);
            WriteColumn(footerTable, 4, "Employee Signature:", Element.ALIGN_LEFT, _reportFont);
            WriteColumn(footerTable, 4, " ", Element.ALIGN_LEFT, _reportFont);
            WriteColumn(footerTable, 3, "Customer Signature:", Element.ALIGN_LEFT, _reportFont);
            
            // changed from 2 to 5 to add a little more room.
            WriteBlankRow(footerTable, 5);

            WriteColumn(footerTable, 4, "______________________________", Element.ALIGN_LEFT, _reportFont);
            WriteColumn(footerTable, 4, " ", Element.ALIGN_LEFT, _reportFont);
            WriteColumn(footerTable, 3, "______________________________", Element.ALIGN_LEFT, _reportFont);
        }
