...
using Utilities = iTextSharp.text.Utilities;

namespace Common.Controllers.Database
{
    public class PurchaseDocumentIndiana
    {
        ...
        public const string PURCHASE_AUXINFOTAG = "purchaseindiana";
        public static object mutex = new object();

        public class BuyDocumentReportStorageIndiana
        {
            ...
            public BuyDocumentReportStorageIndiana(bool isReturn, bool isVendor)
            {
                ...
                else
                {
                    ...
                    this.IndemnityStatementLine3 = string.Empty; 
                }

                this.CustomerPurchaseDisclaimerLine1 =
                    @"For the purchase price set below, the undersigned seller warranting good title, that transfer thereof is rightful and that such ";
                this.CustomerPurchaseDisclaimerLine2 =
                    @"goods are free of any security interest, other lien, or encumbrance.";
                ...
                this.BuyLabel =
                    ...
                    this.BuyReportTitle =
                            (this.IsReturn ? @"Merchandise Return Receipt"
                                 : (this.IsVendor ? @"Merchandise Purchase(Vendor) Receipt" : @"Bill of Sale"));
        ...
        public class BuyPdfCustomHandlerIndiana : PdfPageEventHelper
        {
            private bool chkItem = false;
           ...
           
            {
                ...
                var len = buyRptStore.StandardFont.BaseFont.GetWidthPoint(text,8);
                b.BeginText();
                b.SetFontAndSize(buyRptStore.StandardFont.BaseFont, 8);
                b.SetTextMatrix(458, 680 + templateMatrixXOffset);
                b.ShowText(text);
                b.EndText();
                b.AddTemplate(buyRptStore.PageXYTemplate, 458 + len, 680 + templateMatrixXOffset);
                pTable.AddCell(generateBlankCell(1));
                ...
                if (!buyRptStore.IsCustomerDataFirst)
                {
                    ...
                    //Check if notns return, print disclaimer
            ...
            {
                // Footer
                document.Add(generateBuyFooter(this, chkExpenseItem));
            ...
            public PurchaseDocumentIndiana.BuyDocumentReportStorageIndiana buyRptStore { private set; get; }
            ...
            public BuyPdfCustomHandlerIndiana(bool isReturn, bool isVendor)
            {
                this.buyRptStore = new PurchaseDocumentIndiana.BuyDocumentReportStorageIndiana(isReturn, isVendor);
            }
        }
        ...
        public static bool GeneratePurchaseDocumentIndiana(
                  DesktopSession dSession,
                  PurchaseVO purchase,
                  out string fileNameGenerated)
        {
            fileNameGenerated = string.Empty;
            const string here = "PurchaseDocumentIndiana";
            var fLog = FileLogger.Instance;
            if (fLog.IsLogDebug)
            {
                fLog.logMessage(LogLevel.DEBUG, here, "GeneratePurchaseDocumentIndiana()...");
            }
            if (purchase == null)
            {
            ...
            var customPdfHandler =
                new PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana(
                    isReturn,
                    isVendor);
            ...
            var pageSize = PageSize.HALFLETTER.Rotate();
            float marginTop = 5;
            ...
            try
            {
                ...
                foreach (var item in purchase.Items)
                {
                    ...
                    itemTable = new PdfPTable(itemTableCols);
                    itemTable.DefaultCell.Border = PdfPCell.NO_BORDER;
                    itemTable.DefaultCell.BorderColor = BaseColor.WHITE;

                    // Add a blank line for separation
                    itemTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankLine(itemTableCols));



                    if (item.Quantity > 1)
                    {
                        Item itemCopy = Libraries.Utility.Utilities.CloneObject(item);
                        string sItemPrefix;
                        string sDescription;
                    ...
                    //Cell #1
                    var itemNumCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell(itemIdx + ") " + item.TicketDescription, tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref itemNumCell, 2, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    if (item.IsExpenseItem)
                    {
                        ...
                        expenseItem = true;
                        chkExpenseItem = true;
                        var itemExpenseCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell("[E]", tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                        PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref itemExpenseCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.C, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                        itemExpenseCell.NoWrap = false;
                        itemTable.AddCell(itemExpenseCell);
                    }
                    else
                    {
                        var itemExpenseCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell(string.Empty, tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                        PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref itemExpenseCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.C, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                        itemExpenseCell.NoWrap = false;
                        itemTable.AddCell(itemExpenseCell);
                    }
                    ...
                    //Cell #2
                    var itemQtyCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell(itemQty + " @ ", tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref itemQtyCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    itemQtyCell.NoWrap = true;
                    itemTable.AddCell(itemQtyCell);

                    //Cell #3
                    //itemTable.AddCell(BuyPdfCustomHandlerIndiana.generateBlankCell(1));

                    //Cell #4
                    var itemAmtCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell(String.Format("{0:C}", item.ItemAmount), tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref itemAmtCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    //Cell #6
                    var itemTotAmtCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell(String.Format("{0:C}", priceOfItemRow),
                                                                         tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref itemTotAmtCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    if (rcount % 2 == 0 && rcount != 0 && rcount < purchase.Items.Count)
                    {
                        document.NewPage();

                        ////Add a blank line to the end of the table
                        if (rcount == purchase.Items.Count)
                            itemTable.AddCell(BuyPdfCustomHandlerIndiana.generateBlankLine(itemTableCols));
               ...
               totalTable.AddCell(BuyPdfCustomHandlerIndiana.generateBlankLine(2));
                ...
                var totTendTypeCell = PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell("PAID BY: " + paidBy, tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref totTendTypeCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                totTendTypeCell.NoWrap = true;
                totalTable.AddCell(totTendTypeCell);
                var totAmtCell =
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.genTextCell("TOTAL: " + String.Format("{0:C}", totalAmt).PadLeft(6, ' '), tabFont, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref totAmtCell, 1, PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    dSession.LaserPrinter.IsValid)
                {
                    ...
                    {
                        FileLogger.Instance.logMessage(LogLevel.INFO, "PurchaseDocumentIndiana", "Printing purchase ticket on {0}",
        ...
        private static PdfPTable generateBuyFooter(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana customPdfHandler, bool expenseitem)
        {
            float lineHeight = 10;
            ...
            // Add a blank line for separation
            pTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankLine(3));
            ...
            if (!customPdfHandler.buyRptStore.IsVendor)
            {
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref indemnityCell1, 3, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref indemnityCell2, 3, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                pTable.AddCell(indemnityCell2);

                if (!string.IsNullOrWhiteSpace(customPdfHandler.buyRptStore.IndemnityStatementLine3)) 
                {
                    var indemnityCell3 =
                        new PdfPCell(new Phrase(customPdfHandler.buyRptStore.IndemnityStatementLine3, customPdfHandler.buyRptStore.StandardFont));
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref indemnityCell3, 3, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
            ...
            if (!customPdfHandler.buyRptStore.IsReturn)
            {
                ...
                if (!customPdfHandler.buyRptStore.IsVendor)
                {
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref signatureCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    pTable.AddCell(signatureCell);
                }
                else
                {
                    pTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankCell(1));
                }
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref custInfoCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                if (!customPdfHandler.buyRptStore.IsVendor)
                {
                    ...
                    if (customPdfHandler.buyRptStore.IdentificationInfo != null)
                    {
                        ...
                        {
                            var idTextCell =
                                new PdfPCell(new Phrase(customPdfHandler.buyRptStore.IdentificationInfo.IdIssuerCode+"    "+ @"DL", customPdfHandler.buyRptStore.StandardFont));
                            PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref idTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                        ...
                        {
                            var idTextCell =
                                new PdfPCell(new Phrase(customPdfHandler.buyRptStore.IdentificationInfo.IdIssuerCode + "    " + @"ID", customPdfHandler.buyRptStore.StandardFont));
                            PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref idTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                            idTextCell.FixedHeight = lineHeight;
                            idTextCell.NoWrap = true;
                            idTextCell.BorderWidth = 0.0f;
                        ...
                        PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref idCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                else
                {
                    if (expenseitem)
                    {
                        ...
                        PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref expenseCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref custAddressCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                if (!customPdfHandler.buyRptStore.IsVendor)
                {
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref dOBTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref dOBCell, 1, R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    dOBCell.FixedHeight = lineHeight;
                    dOBCell.NoWrap = true;

                    var heightTextCell =
                        new PdfPCell(new Phrase(@"Ht.", customPdfHandler.buyRptStore.StandardFont));
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref heightTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref heightCell, 1, R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    innerTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankCell(1));
                ...
                else
                {
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref empSignatureCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref custLocationCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                if (!customPdfHandler.buyRptStore.IsVendor)
                {
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref ageTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref ageCell, 1, R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ageCell.FixedHeight = lineHeight;
                    ageCell.NoWrap = true;

                    var sexTextCell =
                    new PdfPCell(new Phrase(@"Sex", customPdfHandler.buyRptStore.StandardFont));
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref sexTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref sexCell, 1, R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    secondInnerTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankCell(1));
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref custPhoneCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                if (!customPdfHandler.buyRptStore.IsVendor)
                {
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref weightTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref weightCell, 1, R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    weightCell.NoWrap = true;

                    var raceTextCell =
                    new PdfPCell(new Phrase(@"Race", customPdfHandler.buyRptStore.StandardFont));
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref raceTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref raceCell, 1, R, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    raceCell.NoWrap = true;

                    // Make four column table to hold the data for DOB and Height
                    var thirdInnerTable = new PdfPTable(5);
                    thirdInnerTable.AddCell(weightTextCell);
                    thirdInnerTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankCell(1));
                    ...
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref custAuxIdCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                    pTable.AddCell(custAuxIdCell);
                }
                else
                {
                    pTable.AddCell(PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.generateBlankCell(2));
                    ...
                    new PdfPCell(new Phrase(@"Fed. Tax ID: " + customPdfHandler.buyRptStore.FederalTaxId,
                                            customPdfHandler.buyRptStore.StandardFont));
                    PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref federalTaxIdCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
            ...
            else
            {
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref signatureTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
                ...
                PurchaseDocumentIndiana.BuyPdfCustomHandlerIndiana.setDefault(ref empSignatureTextCell, 1, L, customPdfHandler.buyRptStore.IsReturn, customPdfHandler.buyRptStore.IsVendor);
        ...
        public static bool chkExpenseItem { get; set; }
    }
}
