...
namespace Common.Controllers.Application.ApplicationFlow.Blocks.Executors
{
    ...
    public class MultiExecuteParallelBlock : BaseBlock
    {
        private List<ActionBlock> fxns;
        public static readonly string NAMEAPPEND = "-MultiExecuteParallelBlock-";
        public Dictionary<string, bool> completionMap;
        ...
        public MultiExecuteParallelBlock(string nm)
        {
            this.setName(nm);
