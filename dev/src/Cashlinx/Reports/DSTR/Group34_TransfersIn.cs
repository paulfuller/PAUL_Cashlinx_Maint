...
{
    public class Group34_TransfersIn : AbstractDSTRGroup
    {
        private decimal _TotalAmount;
        private int _CountNonVoided;

        public Group34_TransfersIn(DSTRReportContext dstrContext, string dataTableName)
        ...
        protected override void OnBuildSection()
        {
            try
            {
                ...
                AddGroupTitle(dataTable, "Transfer Out");
