...
namespace Common.Libraries.Utility.BarcodeGenerator.Symbologies
{
    class Codabar: BarcodeCommon, IBarcode
    {
        ...
        {
            if (Raw_Data.Length < 2) throw new System.Exception("ECODABAR-1: Data format invalid. (Invalid length)");
            ...
            switch (Raw_Data[0].ToString().ToUpper().Trim())
            {
                ...
                case "C": break;
                case "D": break;
                default: throw new System.Exception("ECODABAR-2: Data format invalid. (Invalid START character)");
            }//switch
            ...
            switch (Raw_Data[Raw_Data.Trim().Length - 1].ToString().ToUpper().Trim())
            {
                ...
                case "C": break;
                case "D": break;
                default: throw new System.Exception("ECODABAR-3: Data format invalid. (Invalid STOP character)");
            }//switch
