...
{
    public class Conversion : Singleton<Conversion>
    {
        ...
        public int? ToNullableInt32(object value, int? defaultValue)
        {
            return value == null ? defaultValue : ToNullableInt32(value.ToString(), defaultValue);
        }

        public int? ToNullableInt32(string value, int? defaultValue)
        {
            int result;
        ...
        {
            return value == null ? null : ToNullableInt32(value.ToString());
        }

        public int? ToNullableInt32(string value)
        {
        ...
        public decimal? ToNullableDecimal(object value, decimal? defaultValue)
        {
            return value == null ? defaultValue : ToNullableDecimal(value.ToString(), defaultValue);
        }

        public decimal? ToNullableDecimal(string value, decimal? defaultValue)
        {
            decimal result;
        ...
        {
            return value == null ? null : ToNullableDecimal(value.ToString());
        }
